...
public class PIC_Group_Detail_POINTDATA:IDynCodeAttachDetach
{
...
public void  AttachPictureEventHandler(DrawArea area)
{
   ...
   strEventName = "KeyUp";
_KeyEventHandler= (KeyEventHandler)PIC_Group_Detail_POINTDATA_KeyUp;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_KeyEventHandler);
strEventName = "OnDynInitialize";
_EventHandler= (EventHandler)PIC_Group_Detail_POINTDATA_OnDynInitialize;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)PIC_Group_Detail_POINTDATA_OnDynAnimation;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strObjectName = "ENTER";
...
//Event Handler:KeyUp 
public void PIC_Group_Detail_POINTDATA_KeyUp(Object sender, KeyEventArgs e)
{
...
public void PIC_Group_Detail_POINTDATA_OnDynInitialize(Object sender, EventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
...
public void PIC_Group_Detail_POINTDATA_OnDynAnimation(Object sender, EventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
   DynEventArgs dynArgs = (DynEventArgs)e; 
   DrawArea drawArea = (DrawArea)dynArgs.sender; 
