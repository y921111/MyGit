...
public class PIC_CZ_PMPID_Detail2:IDynCodeAttachDetach
{
...
_EventHandler= (EventHandler)PIC_CZ_PMPID_Detail2_OnDynInitialize;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)PIC_CZ_PMPID_Detail2_OnDynAnimation;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strObjectName = "CTL";
...
public void PIC_CZ_PMPID_Detail2_OnDynInitialize(Object sender, EventArgs e)
{
...
public void PIC_CZ_PMPID_Detail2_OnDynAnimation(Object sender, EventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
   DynEventArgs dynArgs = (DynEventArgs)e; 
   DrawArea drawArea = (DrawArea)dynArgs.sender; 
