...
public class PIC_TDC_ChangeZone:IDynCodeAttachDetach
{
...
_EventHandler= (EventHandler)PIC_TDC_ChangeZone_OnDynInitialize;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)PIC_TDC_ChangeZone_OnDynAnimation;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
...
public void PIC_TDC_ChangeZone_OnDynInitialize(Object sender, EventArgs e)
{
...
public void PIC_TDC_ChangeZone_OnDynAnimation(Object sender, EventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
   DynEventArgs dynArgs = (DynEventArgs)e; 
   DrawArea drawArea = (DrawArea)dynArgs.sender; 
