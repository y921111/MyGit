...
public class PIC_CZ_PMDIGCOM_Detail:IDynCodeAttachDetach
{
...
_EventHandler= (EventHandler)PIC_CZ_PMDIGCOM_Detail_OnDynInitialize;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)PIC_CZ_PMDIGCOM_Detail_OnDynAnimation;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strObjectName = "PAGE";
...
strEventName = "KeyUp";
_KeyEventHandler= (KeyEventHandler)TDC3000_Top_KeyUp;
CodeDomCommon.AttachEventHandler(area,strObjectName,strEventName,_KeyEventHandler);
strObjectName = "TDC3000_Top";
strEventName = "OnDynInitialize";
...
public void PIC_CZ_PMDIGCOM_Detail_OnDynInitialize(Object sender, EventArgs e)
{
...
public void PIC_CZ_PMDIGCOM_Detail_OnDynAnimation(Object sender, EventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
   DynEventArgs dynArgs = (DynEventArgs)e; 
   DrawArea drawArea = (DrawArea)dynArgs.sender; 
...
public void Detail_PAGE_Rect3_CTLCONCT_OnDynClick(Object sender, EventArgs e)
{
	...
	string[] strVariable = new string[1];
	strVariable[0] = Area.Variable[0];
	CommonFunction.OpenPicture("CZ_PMDIGCOM_Detail2.grf", nTop, nLeft, strVariable);
    Area.Visible = false;
...
//Event Delegate:KeyEventHandler 
//Event Handler:KeyUp 
public void TDC3000_Top_KeyUp(Object sender, KeyEventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
