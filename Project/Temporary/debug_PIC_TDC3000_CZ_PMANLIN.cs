...
public class PIC_TDC3000_CZ_PMANLIN:IDynCodeAttachDetach
{
...
_EventHandler= (EventHandler)PIC_TDC3000_CZ_PMANLIN_OnDynInitialize;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)PIC_TDC3000_CZ_PMANLIN_OnDynAnimation;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strEventName = "OnDynClick";
_EventHandler= (EventHandler)PIC_TDC3000_CZ_PMANLIN_OnDynClick;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strEventName = "KeyUp";
_KeyEventHandler= (KeyEventHandler)PIC_TDC3000_CZ_PMANLIN_KeyUp;
...
public void PIC_TDC3000_CZ_PMANLIN_OnDynInitialize(Object sender, EventArgs e)
{
...
public void PIC_TDC3000_CZ_PMANLIN_OnDynAnimation(Object sender, EventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
   DynEventArgs dynArgs = (DynEventArgs)e; 
   DrawArea drawArea = (DrawArea)dynArgs.sender; 
...
public void PIC_TDC3000_CZ_PMANLIN_OnDynClick(Object sender, EventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
   DynEventArgs dynArgs = (DynEventArgs)e; 
   DrawArea drawArea = (DrawArea)dynArgs.sender; 
...
//Event Handler:KeyUp 
public void PIC_TDC3000_CZ_PMANLIN_KeyUp(Object sender, KeyEventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
