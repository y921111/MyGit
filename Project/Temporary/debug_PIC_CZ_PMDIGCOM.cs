...
public class PIC_CZ_PMDIGCOM:IDynCodeAttachDetach
{
...
_EventHandler= (EventHandler)PIC_CZ_PMDIGCOM_OnDynInitialize;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)PIC_CZ_PMDIGCOM_OnDynAnimation;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strEventName = "KeyUp";
_KeyEventHandler= (KeyEventHandler)PIC_CZ_PMDIGCOM_KeyUp;
...
public void PIC_CZ_PMDIGCOM_OnDynInitialize(Object sender, EventArgs e)
{
...
public void PIC_CZ_PMDIGCOM_OnDynAnimation(Object sender, EventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
   DynEventArgs dynArgs = (DynEventArgs)e; 
   DrawArea drawArea = (DrawArea)dynArgs.sender; 
...
//Event Handler:KeyUp 
public void PIC_CZ_PMDIGCOM_KeyUp(Object sender, KeyEventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
   string tagName = Area.Variable[0] + "/OP";
