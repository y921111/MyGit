...
public class PIC_US02:IDynCodeAttachDetach
{
...
strObjectName = "DrawArea2.PV";
strEventName = "OnDynInitialize";
_EventHandler= (EventHandler)DrawArea2_PV_OnDynInitialize;
CodeDomCommon.AttachEventHandler(area,strObjectName,strEventName,_EventHandler);
strObjectName = "DrawArea2.PV";
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)DrawArea2_PV_OnDynAnimation;
CodeDomCommon.AttachEventHandler(area,strObjectName,strEventName,_EventHandler);
strObjectName = "DrawArea2.TagName";
strEventName = "OnDynInitialize";
_EventHandler= (EventHandler)DrawArea2_TagName_OnDynInitialize;
CodeDomCommon.AttachEventHandler(area,strObjectName,strEventName,_EventHandler);
...
public void DrawArea2_PV_OnDynInitialize(Object sender, EventArgs e)
{
    DrawArea Area = (DrawArea)sender; 
    DynEventArgs dynArgs = (DynEventArgs)e; 
...
public void DrawArea2_PV_OnDynAnimation(Object sender, EventArgs e)
{
    DrawArea Area = (DrawArea)sender; 
    DynEventArgs dynArgs = (DynEventArgs)e; 
    DrawText PV = (DrawText)dynArgs.sender; 
...
//Event Delegate:EventHandler 
//Event Handler:OnDynInitialize 
public void DrawArea2_TagName_OnDynInitialize(Object sender, EventArgs e)
{
    DrawArea Area = (DrawArea)sender; 
    DynEventArgs dynArgs = (DynEventArgs)e; 
