...
public class PIC_group_single:IDynCodeAttachDetach
{
...
_EventHandler= (EventHandler)PIC_group_single_OnDynInitialize;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)PIC_group_single_OnDynAnimation;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
...
public void PIC_group_single_OnDynInitialize(Object sender, EventArgs e)
{
...
public void PIC_group_single_OnDynAnimation(Object sender, EventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
   DynEventArgs dynArgs = (DynEventArgs)e; 
   DrawArea drawArea = (DrawArea)dynArgs.sender; 
