...
public class PIC_CZ_PMPID_Detail:IDynCodeAttachDetach
{
...
_EventHandler= (EventHandler)PIC_CZ_PMPID_Detail_OnDynInitialize;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)PIC_CZ_PMPID_Detail_OnDynAnimation;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
...
_EventHandler= (EventHandler)Group_Detail_Disposed;
CodeDomCommon.AttachEventHandler(area,strObjectName,strEventName,_EventHandler);
strObjectName = "Group_Detail";
strEventName = "KeyUp";
_KeyEventHandler= (KeyEventHandler)Group_Detail_KeyUp;
CodeDomCommon.AttachEventHandler(area,strObjectName,strEventName,_KeyEventHandler);
strObjectName = "Group_Detail.ALM";
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)Group_Detail_ALM_OnDynAnimation;
CodeDomCommon.AttachEventHandler(area,strObjectName,strEventName,_EventHandler);
...
public void PIC_CZ_PMPID_Detail_OnDynInitialize(Object sender, EventArgs e)
{
...
public void PIC_CZ_PMPID_Detail_OnDynAnimation(Object sender, EventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
   DynEventArgs dynArgs = (DynEventArgs)e; 
   DrawArea drawArea = (DrawArea)dynArgs.sender; 
...
public void Group_Detail_Disposed(Object sender, EventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
   DynEventArgs dynArgs = (DynEventArgs)e; 
   DrawArea drawArea = (DrawArea)dynArgs.sender; 
...
//Event Delegate:KeyEventHandler 
//Event Handler:KeyUp 
public void Group_Detail_KeyUp(Object sender, KeyEventArgs e)
{
   TextBox TB = (TextBox)sender; 
   DrawArea Area = CommonFunction.GetThisDrawArea(TB);
...
//Event Delegate:EventHandler 
//Event Handler:OnDynAnimation 
public void Group_Detail_ALM_OnDynAnimation(Object sender, EventArgs e)
{
    DrawArea Area = (DrawArea)sender; 
    DynEventArgs dynArgs = (DynEventArgs)e; 
