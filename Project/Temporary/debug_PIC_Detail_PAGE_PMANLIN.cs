...
public class PIC_Detail_PAGE_PMANLIN:IDynCodeAttachDetach
{
...
_EventHandler= (EventHandler)PIC_Detail_PAGE_PMANLIN_OnDynInitialize;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)PIC_Detail_PAGE_PMANLIN_OnDynAnimation;
CodeDomCommon.AttachAreaEventHandler(area,strEventName,_EventHandler);
...
public void PIC_Detail_PAGE_PMANLIN_OnDynInitialize(Object sender, EventArgs e)
{
...
public void PIC_Detail_PAGE_PMANLIN_OnDynAnimation(Object sender, EventArgs e)
{
   DrawArea Area = (DrawArea)sender; 
   DynEventArgs dynArgs = (DynEventArgs)e; 
   DrawArea drawArea = (DrawArea)dynArgs.sender; 
