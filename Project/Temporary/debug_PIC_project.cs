...
public class PIC_project:IDynCodeAttachDetach
{
...
strEventName = "KeyUp";
_KeyEventHandler= (KeyEventHandler)DrawArea2_KeyUp;
...
strObjectName = "DrawArea2.Text3";
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)DrawArea2_Text3_OnDynAnimation;
CodeDomCommon.AttachEventHandler(area,strObjectName,strEventName,_EventHandler);
strObjectName = "DrawArea2.Text2";
strEventName = "OnDynInitialize";
_EventHandler= (EventHandler)DrawArea2_Text2_OnDynInitialize;
CodeDomCommon.AttachEventHandler(area,strObjectName,strEventName,_EventHandler);
strObjectName = "DrawArea2.Text1";
strEventName = "OnDynInitialize";
_EventHandler= (EventHandler)DrawArea2_Text1_OnDynInitialize;
CodeDomCommon.AttachEventHandler(area,strObjectName,strEventName,_EventHandler);
strObjectName = "DrawArea2.Text1";
strEventName = "OnDynAnimation";
_EventHandler= (EventHandler)DrawArea2_Text1_OnDynAnimation;
CodeDomCommon.AttachEventHandler(area,strObjectName,strEventName,_EventHandler);
...
//Event Handler:KeyUp 
public void DrawArea2_KeyUp(Object sender, KeyEventArgs e)
{
...
public void DrawArea2_Text3_OnDynAnimation(Object sender, EventArgs e)
{
    DrawArea Area = (DrawArea)sender; 
    DynEventArgs dynArgs = (DynEventArgs)e; 
...
//Event Delegate:EventHandler 
//Event Handler:OnDynInitialize 
public void DrawArea2_Text2_OnDynInitialize(Object sender, EventArgs e)
{
    DrawArea Area = (DrawArea)sender; 
    DynEventArgs dynArgs = (DynEventArgs)e; 
...
//Event Delegate:EventHandler 
//Event Handler:OnDynInitialize 
public void DrawArea2_Text1_OnDynInitialize(Object sender, EventArgs e)
{
    DrawArea Area = (DrawArea)sender; 
    DynEventArgs dynArgs = (DynEventArgs)e; 
...
//Event Delegate:EventHandler 
//Event Handler:OnDynAnimation 
public void DrawArea2_Text1_OnDynAnimation(Object sender, EventArgs e)
{
    DrawArea Area = (DrawArea)sender; 
    DynEventArgs dynArgs = (DynEventArgs)e; 
    DrawText Text1 = (DrawText)dynArgs.sender; 
